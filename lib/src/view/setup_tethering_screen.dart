      ...
      children: [
        RichText(
          text: TextSpan(
            style: textTheme,
            children: [
              const TextSpan(text: 'In your phone\'s settings, find '),
              TextSpan(text: 'Hotspot & Tethering', style: textTheme!.copyWith(fontWeight: FontWeight.bold)),
              const TextSpan(text: '. This normally lives under "Network & Internet" or "Connections."\n\nLook for the '),
              TextSpan(text: 'Bluetooth tethering', style: textTheme.copyWith(fontWeight: FontWeight.bold)),
              const TextSpan(text: ' toggle and make sure it\'s enabled:'),
            ],
          ),
        ),
        const SizedBox(height: 24),
